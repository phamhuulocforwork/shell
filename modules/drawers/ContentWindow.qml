...
StyledWindow {
    ...
    Item {
        ...
        PanelBg {
            ...
            deformAmount: 0.2
            y: panels.sessionWrapper.y + panels.session.y + bar.implicitHeight
        ...
        PanelBg {
            ...
            y: panels.popoutsWrapper.y + bar.implicitHeight - panels.popoutsWrapper.height * extraHeight
            implicitHeight: Math.max(0, panels.popoutsWrapper.height * (1 + extraHeight))
